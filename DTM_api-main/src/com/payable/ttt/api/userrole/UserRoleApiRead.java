...
public abstract class UserRoleApiRead extends TeamTimeTrackerBaseHandler {
	...
	public UserRoleApiRead() {
		super();
		dbm_CorpUserRole = new BaseDbManager<ORMUserRole>(hibernateFactory);
		dbm_CorpUser = new BaseDbManager<ORMUser>(hibernateFactory);
	}
	...
	protected String processRequest(HttpServletRequest request, HttpServletResponse response, ORMUser user,
		...
		return processCorpUserRole(csr, userId, ipAddress);
	}

	protected abstract String processCorpUserRole(CommonSearchRequest csr, String userId, String ipAddress)
